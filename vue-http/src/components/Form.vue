...
onMounted(async () => {
  ...
  data.value = await axios.get('https://vue-example-3775d-default-rtdb.firebaseio.com/surveys.json')
  console.log(data.value)
  isLoading.value = false
})

const onSubmit = (e: Event) => {
  axios.post('https://vue-example-3775d-default-rtdb.firebaseio.com/surveys.json', {
    name: userName.value,
